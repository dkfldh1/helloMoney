...
<form class="signUp" id="signupForm">
   <h1 class="signUpTitle">관리자페이지</h1>
   <input type="text" class="signUpInput" placeholder="id" autofocus required id = "id">
   <input type="password" class="signUpInput"  id="password" placeholder="password" required >
   <input type="button" value="로그인" class="signUpButton">  
</form>
<script>
$(function(){
	...
	$(".signUpButton").click(function(){
		...
		$.ajax({
			...
			success : function(data) {  
				if(data.indexOf("signUp")!= -1) alert("로그인 실패!")
