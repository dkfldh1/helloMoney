...
<html>
	<head>
		...
		<link rel="shortcut icon" type="image/x-icon" href="/resource/images/fav-icon.png" />
	...
	<body>
		<!---start-wrap---->
			...
			<div class="header">
				<div class="wrap">
				<div class="logo">
					<a href="index.jsp"><img src="/resource/images/logo.png" title="pinbal" /></a>
				</div>
				<div class="nav-icon">
				...
				<div class="userinfo">
					<div class="user">
						<ul>
							<li><a href="#"><img src="/resource/images/user-pic.png" title="user-name" /><span>Ipsum</span></a></li>
						</ul>
					</div>
				</div>
				<div class="clear"> </div>
					 ...
					 <div class="contact-grids">
							 <div class="col_1_of_bottom span_1_of_first1">
								...
								<div class="col_1_of_bottom span_1_of_first1">
									...
									<ul class="list3">
										<li>
											   <img src="/resource/images/phone.png" alt="">
											<div class="extra-wrap">
												<p><span>Telephone:</span>+1 800 258 2598</p>
											</div>
												<img src="/resource/images/fax.png" alt="">
											<div class="extra-wrap">
