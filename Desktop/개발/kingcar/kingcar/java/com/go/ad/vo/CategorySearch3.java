...
public class CategorySearch3 {
  ...
  public static void main(String[] args) {
    ...
    try {
      InputStream in = CategorySearch3.class.getResourceAsStream(PROPERTIES_FILENAME);
      properties.load(in);
...
//      search.setPageToken("");
       ...
       * efficient.
       */
      search.setFields("items(id/kind,id/videoId,snippet/title,snippet/thumbnails/default/url,snippet/channelTitle), nextPageToken,pageInfo(totalResults)");
//      search.setPageToken("CAIQAA");
      ...
      String videoCount = searchResponse.toString();
      System.out.println("검색된 총 동영상 수 : " + videoCount);
  ...
  private static void prettyPrint(Iterator<SearchResult> iteratorSearchResults, String query, String apiKey) throws IOException {
    ...
    while (iteratorSearchResults.hasNext()) {
      ...
      if (rId.getKind().equals("youtube#video")) {
        ...
        System.out.println(" ChannelId: " + singleVideo.getSnippet().get("channelTitle"));
        System.out.println(" view count: "+ statistics.get("viewCount"));
